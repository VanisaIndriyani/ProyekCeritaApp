...
try {
    ...
    $story = $storyRepository->findById((int)$storyId);
    
    if (!$story || $story->getUserId() !== $user['id']) {
        $_SESSION['error'] = 'Story tidak ditemukan atau Anda tidak memiliki akses';
        header('Location: /user');
        exit;
    }
} catch (Exception $e) {
    $_SESSION['error'] = 'Gagal memuat story: ' . $e->getMessage();
    header('Location: /user');
    exit;
}
...
<main class="story-form-main">
    <div class="container">
        ...
        <div class="page-header">
            ...
            <p class="page-subtitle">Perbarui dan sempurnakan cerita Anda</p>
        </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" 
                                   ...
                                   value="<?= htmlspecialchars($_POST['title'] ?? $story->getTitle()) ?>"
                                   required>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <select id="category" name="category" class="form-control" required>
                                ...
                                <?php 
                                $categories = ['Akademik', 'Karir', 'Kehidupan', 'Technology', 'Organisasi', 'Magang', 'Kompetisi', 'Wisuda'];
                                $currentCategory = $_POST['category'] ?? $story->getCategory();
                        ...
                        <div class="form-group">
                            ...
                            <?php if ($story->getCoverImage()): ?>
                                <div class="current-image">
                                    <p class="current-image-label">Cover saat ini:</p>
                            ...
                            <div class="file-upload-area">
                                ...
                                <div class="file-upload-content">
                                    ...
                                    <p><?= $story->getCoverImage() ? 'Upload gambar baru' : 'Klik untuk upload atau drag & drop gambar' ?></p>
                                    <span class="file-requirements">Format: JPG, PNG, GIF (Max: 5MB)</span>
                                </div>
                            </div>
                            <div class="form-help">
                                <?= $story->getCoverImage() ? 'Biarkan kosong jika tidak ingin mengubah cover' : 'Cover image akan membuat cerita Anda lebih menarik' ?>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <textarea id="content" 
                                      ...
                                      rows="15" 
                                      required><?= htmlspecialchars($_POST['content'] ?? $story->getContent()) ?></textarea>
                            <div class="form-help">
...
<style>
/* Style untuk full PHP version - sama seperti create */
.alert {
    padding: 12px 16px;
    margin-bottom: 20px;
    border-radius: 6px;
